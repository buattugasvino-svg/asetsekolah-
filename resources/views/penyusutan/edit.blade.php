...
<head>
    ...
    <title>Edit Penyusutan - Inventaris</title>
    <style>
        * {
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('penyusutan.update', $penyusutan->id_penyusutan) }}" method="POST">
            ...
            {{-- 1. ID Penyusutan (Readonly) --}}
            <div class="form-group">
                <label for="id_penyusutan">ID Penyusutan</label>
                <input type="text" name="id_penyusutan" id="id_penyusutan" class="form-control" value="{{ $penyusutan->id_penyusutan }}" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="id_barang" id="id_barang" class="form-control" required>
                    ...
                    @foreach ($barang as $item)
                        <option value="{{ $item->id_barang }}" {{ old('id_barang', $penyusutan->id_barang) == $item->id_barang ? 'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <input type="number" name="nilai_penyusutan" id="nilai_penyusutan" class="form-control" value="{{ old('nilai_penyusutan', $penyusutan->nilai_penyusutan) }}" placeholder="Contoh: 500000" min="0" required>
            </div>

            {{-- Tombol Aksi --}}
            <div class="form-actions">
                <a href="{{ route('penyusutan.index') }}" class="btn btn-secondary">Batal</a>
