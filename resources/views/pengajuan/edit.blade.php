...
<head>
    ...
    <title>Edit Pengajuan - Inventaris</title>
    <style>
        * {
    ...
    <div class="card-body">
        ...
        <form action="{{ route('pengajuan.update', $pengajuan->id_pengajuan) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kode_pengajuan" id="kode_pengajuan" class="form-control" value="{{ old('kode_pengajuan', $pengajuan->kode_pengajuan) }}" required>
            </div>
            ...
            {{-- Status Pengajuan --}}
            <div class="form-group">
                <label for="status">Status Pengajuan <span class="required">*</span></label>
            ...
            <div class="form-group">
                ...
                <textarea name="alasan" id="alasan" class="form-control" required>{{ old('alasan', $pengajuan->alasan) }}</textarea>
            </div>
