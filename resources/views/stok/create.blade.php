...
<head>
    ...
    <title>Tambah Stok - Inventaris</title>
    <style>
        * {
    ...
    <div class="card-body">
        ...
        <form action="{{ route('stok.store') }}" method="POST">
            ...
            <div class="form-group">
                <label for="id_stok">ID Stok <span class="required">*</span></label>
                <input type="text" name="id_stok" id="id_stok" class="form-control" value="{{ old('id_stok') }}" placeholder="Contoh: STK-001" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="jumlah" id="jumlah" class="form-control" value="{{ old('jumlah') }}" placeholder="Contoh: 50" min="0" required>
            </div>
