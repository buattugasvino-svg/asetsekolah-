@extends('layouts.app') {{-- Sesuaikan 'layouts.app' dengan nama/lokasi file master layout kamu (misal: layouts.main / layouts.admin) --}}

@section('content')
<style>
    /* CSS khusus untuk form penambahan barang */
    .card-custom {
        background: #ffffff;
        width: 100%;
        max-width: 600px;
