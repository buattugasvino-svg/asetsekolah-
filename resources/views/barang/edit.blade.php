...
<head>
    ...
    <style>
        * {
        ...
        .card-header {
            background: #d97706; /* Warna oranye/amber untuk membedakan mode Edit */
            color: #ffffff;
            padding: 20px 28px;
        }
    ...
    <div class="card-body">
        ...
        <form action="{{ route('barang.update', $barang->id_barang) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kode_barang" id="kode_barang" class="form-control" value="{{ old('kode_barang', $barang->kode_barang) }}" placeholder="Contoh: BRG-001" required>
            </div>

            {{-- Nama Barang --}}
            <div class="form-group">
                <label for="nama_barang">Nama Barang <span class="required">*</span></label>
                <input type="text" name="nama_barang" id="nama_barang" class="form-control" value="{{ old('nama_barang', $barang->nama_barang) }}" placeholder="Masukkan nama barang" required>
            </div>
